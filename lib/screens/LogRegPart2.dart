...
class LogRegPart2 extends StatefulWidget {
  @override
  _LogRegPart2State createState() => _LogRegPart2State();
}

class _LogRegPart2State extends State<LogRegPart2> {
  String _step = '1';
  bool _isActive = true;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('Basic Simulation Of Logistic Regression', style: kappSubTitle),
        ...
        bottomNavigationBar: BottomBar(
          btext1: 'Introduction to Logistic Regression',
          bonPress1: () {
